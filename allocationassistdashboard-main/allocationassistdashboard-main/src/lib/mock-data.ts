...
export const overviewKpis = [
  ...
  { label: "Doctors Placed", value: "89", change: +18.6, period: "vs Q4 2025", icon: "check" as const },
  { label: "Awaiting License", value: "156", change: +8.2, period: "vs last month", icon: "file" as const },
  { label: "Partner Hospitals", value: "84", change: +4.8, period: "total active", icon: "building" as const },
  { label: "Avg. Time to Place", value: "34 days", change: -12.5, period: "vs last quarter", icon: "clock" as const },
  { label: "Revenue", value: "$1.24M", change: +22.8, period: "vs Q4 2025", icon: "dollar" as const },
];
...
export const placementFunnel = [
  ...
  { stage: "Interviewed", count: 312, pct: 24.3 },
  { stage: "In Licensing", count: 156, pct: 12.1 },
...
export const pipelineStages = [
  ...
  { stage: "Collecting Documents", count: 76, color: "hsl(38, 88%, 50%)" },
  { stage: "Preparing for Interview", count: 54, color: "hsl(280, 50%, 52%)" },
  { stage: "Hospital Interview", count: 38, color: "hsl(340, 60%, 52%)" },
  { stage: "Getting License", count: 28, color: "hsl(158, 50%, 42%)" },
...
export const stageConversion = [
  { stage: "Applied → Screening", rate: 65.6 },
...
export const financeMetrics = [
  ...
  { label: "Cost per Doctor Placed", value: "$802", change: -6.4, period: "vs last quarter" },
  { label: "Return on Investment", value: "17.4x", change: +14.2, period: "vs last quarter" },
];
...
export const pipelineDoctors = [
  { id: "AA-4201", name: "Dr. Amira Khan", specialty: "Cardiology", stage: "Getting License", origin: "UK", destination: "UAE", assignedTo: "Sarah Ahmed", daysInStage: 12, status: "on-track" as const, license: "DHA" },
  ...
  { id: "AA-4192", name: "Dr. Raj Mehta", specialty: "Pediatrics", stage: "Getting License", origin: "India", destination: "Qatar", assignedTo: "Omar Hassan", daysInStage: 28, status: "delayed" as const, license: "QCHP" },
  ...
  { id: "AA-4186", name: "Dr. Chen Wei", specialty: "Internal Medicine", stage: "Collecting Documents", origin: "China", destination: "KSA", assignedTo: "David Kim", daysInStage: 15, status: "at-risk" as const, license: "MOH" },
  ...
  { id: "AA-4180", name: "Dr. Hassan Ali", specialty: "General Surgery", stage: "Preparing for Interview", origin: "Egypt", destination: "KSA", assignedTo: "James Mitchell", daysInStage: 18, status: "at-risk" as const, license: "MOH" },
];

export const workflowStages = [
  { name: "New Application", count: 142 },
  { name: "Screening", count: 98 },
  { name: "Collecting Documents", count: 76 },
  { name: "Preparing for Interview", count: 54 },
  { name: "Hospital Interview", count: 38 },
  { name: "Getting License", count: 28 },
...
export const recentActivity = [
  ...
  { action: "Licensing delayed", detail: "Dr. Raj Mehta — QCHP (28 days, needs attention)", time: "5 hours ago", type: "alert" as const },
  ...
  { action: "New hospital partnership", detail: "Hamad Medical Corporation, Qatar — agreement signed", time: "2 days ago", type: "partnership" as const },
];

// ===== OPERATIONS / ROADMAP =====
export const operationalHealth = [
  { metric: "Processes Documented", value: 35, target: 100, unit: "%" },
  { metric: "Database Accuracy", value: 48, target: 90, unit: "%" },
  { metric: "Avg. Response Time", value: 18, target: 4, unit: "hrs" },
  { metric: "Tasks Automated", value: 12, target: 60, unit: "%" },
];
...
export const roadmapPhases = [
  {
    ...
    progress: 45,
    items: [
      { task: "Define team roles & responsibilities", done: true },
      { task: "Create standard operating procedures", done: false },
      { task: "Clean up database & fix missing data", done: true },
      { task: "Choose CRM system (Zoho vs Custom)", done: false },
      { task: "Launch Doctor Value Package", done: false },
      { task: "Set up customer support team", done: true },
    ],
  },
  {
    ...
    items: [
      ...
      { task: "Create job vacancy management system", done: false },
      { task: "Launch licensing tracking system", done: false },
      { task: "Build performance dashboards", done: false },
      { task: "Expand marketing in Saudi Arabia", done: false },
  ...
  },
  {
    ...
    progress: 0,
    items: [
      { task: "AI-powered job matching", done: false },
      { task: "AI-assisted CV writing", done: false },
      { task: "Doctor portal & mobile app", done: false },
      { task: "European university outreach", done: false },
      { task: "Predictive analytics", done: false },
      { task: "Automate invoicing & payments", done: false },
    ],
  },
];

export const bottlenecks = [
  { area: "Qatar Licensing (QCHP)", severity: "high" as const, avgDelay: "18 days", affected: 8, detail: "Backlog in Qatar license approvals" },
  { area: "Document Collection", severity: "medium" as const, avgDelay: "12 days", affected: 14, detail: "Waiting for doctors to submit credentials" },
  { area: "Hospital Interview Scheduling", severity: "medium" as const, avgDelay: "8 days", affected: 6, detail: "Limited interview slots available" },
  { area: "Data Entry Backlog", severity: "low" as const, avgDelay: "3 days", affected: 22, detail: "Manual data entry falling behind" },
];
