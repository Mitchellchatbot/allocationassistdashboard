...

{
  ...
  "date_of_birth":      string | null,   // The candidate's date of birth, NORMALISED to ISO "YYYY-MM-DD", whenever the CV states one (e.g. "DOB: 15/04/1982", "Date of Birth: April 15, 1982", "Born 4 Sep 1987" → "1982-04-15" / "1987-09-04"). For an ambiguous numeric date assume D/M/Y (non-US CV) unless the CV is clearly US-style. Null if no birth date is stated.
  "age":                number | null,   // Compute from the date of birth if the CV lists one ("DOB: 12/04/1985"). Don't infer from graduation year alone.
