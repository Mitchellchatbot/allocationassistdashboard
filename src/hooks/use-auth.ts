...
export const ALL_PAGES = ["/", "/my-workspace", "/sales", "/marketing", "/doctors", "/team", "/finance", "/meta-ads", "/settings", "/worker", "/calls", "/chatbot", "/follow-ups", "/automations", "/vacancies", "/reports", "/batches", "/profile-sent", "/import-bulk", "/connections", "/forms"];
