...
.dpm .member-badge{display:inline-flex;align-items:center;justify-content:center;height:26px;background:#0e7d6b;border-radius:16px;padding:0 16px 3px;font-size:11.5px;font-weight:600;}
...
.dpm .btn{display:flex;align-items:center;justify-content:center;height:50px;width:100%;padding:0 0 6px;border-radius:10px;font-size:14px;font-weight:600;margin-top:14px;border:none;text-decoration:none;}
...
.dpm .tab{flex:1;display:flex;align-items:center;justify-content:center;height:48px;padding:0 0 6px;font-size:14px;font-weight:700;letter-spacing:.3px;}
