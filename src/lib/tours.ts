...
const PAGE_INTRO_STEPS: Record<string, TourStep> = {
  ...
  "/calls":       { route: "/calls",             target: "calls-toolbar",     placement: "bottom",
    title: "Calls", body: "The sales team's recorded calls (Abraham, Asser, Asim), each with an AI summary, action items, and a searchable transcript. Search across all of them or filter by host." },
  ...
  "/meta-ads":    { route: "/meta-ads",          target: "metaads-overview",  placement: "auto",
