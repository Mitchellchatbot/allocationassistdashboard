...
// Lazy-loaded so the recharts (vendor-charts) chunk is deferred until this
// chart actually mounts. Co-located module keeps all recharts symbols whole.
const IndexTrendChart = lazy(() => import("./IndexTrendChart"));
        ...
        <Card className="lg:col-span-3 shadow-sm border-border/50 hover:shadow-md transition-shadow">
          ...
          <CardContent className="px-2 sm:px-4 pb-4">
            {zohoLoading ? (
              ...
              <Suspense fallback={<div className="h-[240px] bg-muted/30 rounded-lg animate-pulse" />}>
                <IndexTrendChart data={timeData} tip={tip} />
              </Suspense>
            )}
