  ...
  const kpiDefs = kpis.length > 0 ? [
    {
      ...
      hintMeaning: "Qualified leads still active in the pipeline. Excludes Closed Won, Contact in Future, and unqualified leads.",
    ...
    },
    {
      ...
      hintMeaning: "Share of leads that reached Initial Sales Call Completed or High Priority Follow up.",
      hintSource:  "Zoho CRM (Lead_Status).",
