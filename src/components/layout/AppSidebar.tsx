...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader className="px-4 py-4 border-b border-sidebar-border" style={{ backgroundColor: "hsl(170, 45%, 22%)" }}>
        <div className="flex items-center justify-center gap-2.5">
          ...
          {!collapsed && (
            <div className="leading-tight">
              ...
              <span className="text-[10px] text-white/60 block">The source of workforce</span>
            </div>
          )}
        </div>
      </SidebarHeader>
